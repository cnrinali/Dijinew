...
function CorporateProfilePage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                showNotification(err.response?.data?.message || 'Veriler yüklenemedi.', 'error');
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleCompanySubmit = async (e) => {
        ...
        try {
            ...
            const errorMsg = err.response?.data?.message || 'Şirket bilgileri güncellenemedi.';
            showNotification(errorMsg, 'error');
        } finally {
            ...
            <Grid container spacing={4}>
                        ...
                        <CardContent sx={{ p: 3 }}>
                            ...
                            <Box sx={{ mt: 3, pt: 3, borderTop: '1px solid #e0e0e0' }}>
                                ...
                                <Box sx={{ mt: 2 }}>
                                    ...
                                    <Typography variant="body2" sx={{ color: '#1a1a1a', fontWeight: 500 }}>
                                        {companyData.userLimit} Kullanıcı • {companyData.cardLimit} Kartvizit
                                    </Typography>
                                </Box>
                            </Box>
                        </CardContent>
                ...
                <Grid item xs={12} md={8}>
                    <Paper sx={{ 
                            ...
                            {tabIndex === 0 && (
                                <Box component="form" onSubmit={handleProfileSubmit} sx={{ mt: 1 }}>
                                    ...
                                    <Button
                                        ...
                                        disabled={updateLoading}
                                    >
                                        {updateLoading ? <CircularProgress size={24} color="inherit" /> : 'Kurumsal Bilgileri Kaydet'}
                                    </Button>
                                </Box>
                            )}
                        </Box>
                        ...
                        >
                            {tabIndex === 1 && (
                                <Box component="form" onSubmit={handleCompanySubmit} sx={{ mt: 1 }}>
                                    <Grid container spacing={3}>
                                        <Grid item xs={12}>
                                            <TextField
                                                required
                                    ...
                                    <Button
                                        ...
                                        disabled={companyUpdateLoading}
                                    >
                                        {companyUpdateLoading ? <CircularProgress size={24} color="inherit" /> : 'Şirket Bilgilerini Kaydet'}
                                    </Button>
                                </Box>
                            )}
                        </Box>
                            ...
                            {tabIndex === 2 && (
                                <Box component="form" onSubmit={handlePasswordSubmit} sx={{ mt: 1 }}>
                                    ...
                                    <Button
                                        ...
                                        disabled={passwordLoading}
                                    >
                                        {passwordLoading ? <CircularProgress size={24} color="inherit" /> : 'Şifreyi Güncelle'}
                                    </Button>
                                </Box>
                            )}
                        </Box>
