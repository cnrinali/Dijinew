            ...
            >
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid size={{ xs: 12, sm: 6, lg: 12 }}>
                      <Card
                        ...
                        onClick={() =>
                          (window.location.href = "/corporate/users")
                        }
                      >
                        <CardContent
                          sx={{
              ...
              >
                <Box sx={{ p: 2.5 }}>
                  <Typography
                    variant="h6"
                    sx={{ color: "primary.dark", mb: 1, fontWeight: 600 }}
                  >
                    Hoş Geldiniz! 👋
                  </Typography>
                  <Typography
                    variant="body2"
                    sx={{ color: "primary.dark", opacity: 0.8, mb: 2 }}
                  >
                    Kurumsal paneline hoş geldiniz. Şirketinizin dijital
                    kartvizit yönetimini buradan yapabilirsiniz.
                  </Typography>
