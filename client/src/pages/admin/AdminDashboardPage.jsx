...
function AdminDashboardPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setError(
        err.response?.data?.message || "Veriler getirilirken bir hata oluştu."
      );
                  ...
                  <Box sx={{ p: 3 }}>
                    ...
                    >
                      ...
                      <Box>
                        ...
                        <Typography
                          variant="body2"
                          sx={{ color: "success.dark", opacity: 0.8 }}
                        >
                  ...
                  <Box sx={{ p: 3 }}>
                    ...
                    >
                      ...
                      <Box>
                        ...
                        <Typography
                          variant="body2"
                          sx={{ color: "secondary.dark", opacity: 0.8 }}
                        >
                      ...
                      >
                        ...
                        >
                          {systemResources?.storage
                            ? `${systemResources.storage.used}GB / ${systemResources.storage.total}GB`
                            : "0GB / 0GB"}
                        </Typography>
                      </Box>
                      <Box
                      ...
                      >
                        ...
                        >
                          {systemResources?.network
                            ? `${systemResources.network.rx_speed} MB/s`
                            : "0 MB/s"}
                        </Typography>
                      </Box>
                      <Box
                      ...
                      >
                        ...
                        >
                          {systemStatus?.server?.uptime
                            ? `${Math.floor(
                                systemStatus.server.uptime / 3600
                              )}h`
                            : "0h"}
                        </Typography>
                      </Box>
                  ...
                  <Box sx={{ p: 3 }}>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {maintenanceInfo?.last_backup?.display ||
                            "2 saat önce"}
                        </Typography>
                      </Box>
                      <Box
                      ...
                      >
                        ...
                        <Chip
                          ...
                          size="small"
                          color={
                            maintenanceInfo?.active_errors > 0
                              ? "error"
                              : "success"
                          }
                          variant="filled"
                  ...
                  <Box sx={{ p: 3 }}>
                    ...
                    >
                      ...
                      <Box>
                        ...
                        <Typography
                          variant="body2"
                          sx={{ color: "info.dark", opacity: 0.8 }}
                        >
