              ...
              <div class="modal fade" id="hakkimda" tabindex="-1">
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body" align="center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=apple&hesap=<?php echo"$adres"; ?>"><img src="assets/images/apple-maps.png" height="128px"></a> &nbsp;&nbsp;&nbsp;
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=map&hesap=<?php echo"$adres"; ?>"><img src="assets/images/google-maps.png" height="128px"></a> 
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php if($dil =="tr"){echo"Kapat";}elseif($dil =="en"){echo"Close";}elseif($dil =="ru"){echo"Закрывать";}elseif($dil =="sa"){echo"أغلق";}?></button>
                    </div>
...
<a href="<?php echo"$link";?>"><img src="assets/images/dokuman.png"  height="60px"></a>
<br>
...
<div class="dropdown-menu">
		<a class="dropdown-item" href="business?kart_id=<?php echo"$kart_id";?>&dil=tr"><img src="assets/img/turkish.png" style="height:10px;">&nbsp;Türkçe</a>
		<a class="dropdown-item" href="business?kart_id=<?php echo"$kart_id";?>&dil=en"><img src="assets/img/english.png" style="height:10px;">&nbsp;English</a>
		<a class="dropdown-item" href="business?kart_id=<?php echo"$kart_id";?>&dil=ru"><img src="assets/img/russian.png" style="height:10px;">&nbsp;Russian</a>
		<a class="dropdown-item" href="business?kart_id=<?php echo"$kart_id";?>&dil=sa"><img src="assets/img/arabia.png" style="height:10px;">&nbsp;Arabia</a>
</div>
</div>
</div>
<?php
...
?>	  
				...
				<div class="media align-items-left justify-content-left profile-head">
					<div class="profile-qr-code">
						<img src="<?php if(empty($resim)){echo"assets/images/boslogo.jpg";}else{echo"$resim";}?>" id="logo_preview" alt="user" class="img-thumbnail">
					</div>
				</div>
				<div class="align-items-right" style="margin-left:150px; margin-top:-30px; position: relative;">
				<h3 class="name"><?php echo"$isim $soyisim";?> <?php if($cek_id == $uye_id){ ?><a href="yonetim.php" alt="Kartviziti Düzenle" title="Kartviziti Düzenle"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?></h3>
					<div class="headeris">
...
<script>
	...
	{"value":"<?php if(isset($padres)){echo"$domain$profil";echo".pro";}else{echo"$domain";echo"business?kart_id=$kart_id";}?>","label":"Dijital Kartvizit","type":"website"},
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" data-bs-toggle="modal" data-bs-target="#hakkimda" style="text-decoration:none; margin-left:-5px;"><img src="assets/images/hakkimda.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=telefon&hesap=<?php echo"$telefon"; ?>" style="text-decoration:none;"><img src="assets/images/phone.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=telefon&hesap=<?php echo"$gsm"; ?>" style="text-decoration:none;"><img src="assets/images/sphone.png"  height="60px"></a>
<br>
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=telefon&hesap=<?php echo"$gsm"; ?>" style="font-size:8pt;"><?php if($dil =="tr"){echo"GSM";}elseif($dil =="en"){echo"MOBILE TELEPHONE";}elseif($dil =="ru"){echo"ТЕЛЕФОН";}elseif($dil =="sa"){echo"هاتف";}?></a>
</div>
</div>
<?php } 
if(empty($email)) {}else{
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=mail&hesap=<?php echo"$email"; ?>" style="text-decoration:none;"><img src="assets/images/mail.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" data-bs-toggle="modal" data-bs-target="#maps" class="text-dark text-decoration-none"><img src="assets/images/map.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=web&hesap=<?php echo"$web"; ?>" style="text-decoration:none;"><img src="assets/images/web.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" class="youtube-link item appitem" youtubeid="<?php echo"$videolink";?>"><img src="assets/images/video.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=whatsapp&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/whatsapp.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=whatsappkatalog&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/whatsappbusiness.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=telegram&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/telegram.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=facebook&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/facebook.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=twitter&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/twitter.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=instagram&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/instagram.png"  height="60px"></a>
<br>
<a class="text-dark text-decoration-none" style="font-size:8pt;"><?php echo strtoupper($hesap); ?></a>
</div>
</div>
<?php }
if($sosyal == "youtube") {
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=youtube&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/youtube.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=linkedin&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/linkedin.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=pinterest&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/pinterest.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" data-bs-toggle="modal" data-bs-target="#skype" style="text-decoration:none; margin-left:-5px;"><img src="assets/images/skype.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=snapchat&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/snapchat.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=sahibinden&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/sahibinden.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=n11&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/n11.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=trendyol&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/trendyol.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=ciceksepeti&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/ciceksepeti.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=hepsiburada&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/hepsiburada.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=ptt&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/pttavm.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=hepsiemlak&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/hepsiemlak.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=arabam&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/arabam.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=letgo&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/letgo.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" data-bs-toggle="modal" data-bs-target="#wechat" style="text-decoration:none; margin-left:-5px;"><img src="assets/images/wechat.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="istatistik.php?kart_id=<?php echo"$kart_id"; ?>&bilgi=tiktok&hesap=<?php echo"$hesap"; ?>" style="text-decoration:none;"><img src="assets/images/tiktok.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" data-bs-toggle="modal" data-bs-target="#qr" style="text-decoration:none;"><img src="assets/images/qr.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" data-bs-toggle="modal" data-bs-target="#fatura" style="text-decoration:none;"><img src="assets/images/fatura.png?V=0.1"  height="60px"></a>
<br>
<a class="text-dark text-decoration-none" style="font-size:8pt;"><?php if($dil =="tr"){echo"Fatura Bilgileri";}elseif($dil =="en"){echo"BILLING INFORMATION";}elseif($dil =="ru"){echo"Платежная информация";}elseif($dil =="sa"){echo"معلومات الفواتير";}?></a>
</div>
</div>  
 <?php }
if($r_sor !=="0") {
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" data-bs-toggle="modal" data-bs-target="#galeri" style="text-decoration:none;"><img src="assets/images/galeri.png"  height="60px"></a>
<br>
<a class="text-dark text-decoration-none" style="font-size:8pt;"><?php if($dil =="tr"){echo"Ürünler & İlanlar";}elseif($dil =="en"){echo"PRODUCTS & CLASSFIELDS";}elseif($dil =="ru"){echo"Товары и объявления";}elseif($dil =="sa"){echo"المنتجات والإعلانات المبوبة";}?></a>
</div>
</div>  
 <?php }?>
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" id="paylas"><img src="assets/images/paylas.png"  height="60px"></a>
<br>
<a class="text-dark text-decoration-none" style="font-size:8pt;"><?php if($dil =="tr"){echo"KARTVİZİTİ PAYLAŞ";}elseif($dil =="en"){echo"CARDVISIT SHARE";}elseif($dil =="ru"){echo"ПОДЕЛИТЕСЬ СВОЕЙ ВИЗИТНОЙ КАРТОЧКОЙ";}elseif($dil =="sa"){echo"شارك بطاقة عملك";}?></a>
</div>
</div>  
 <?php
if($d_sor !=="0") {
?> 
 <div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a href="#" data-bs-toggle="modal" data-bs-target="#dokuman" style="text-decoration:none;"><img src="assets/images/dokuman.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/garanti.png"  height="60px"></a>
<br>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/deniz.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/halkbank.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/ing.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/akbank.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/hsbc.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/is.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/qnb.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/kuveyt.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/seker.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/teb.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/ziraat.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/ykredi.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/vakif.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/oyak.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
...
<div class="col-4" style="float:left;">
<div class="p-3 text-center">
<a style="text-decoration:none;" id="shareOther" onclick="banka<?php echo"$b_id";?>()"><img src="tema-1-assets/img/banka/ptt.png"  height="60px"></a>
<br>
<a id="shareOther" onclick="banka<?php echo"$b_id";?>()" style="font-size:8pt;"><?php echo"$hesap";?></a>
</div>
</div>
        ...
        if (navigator.canShare) {
            try {
                ...
                await navigator.share({
                    ...
                    url:"<?php echo"$domain";?>business?kart_id=<?php echo"$kart_id";?>"
                })
                console.log("")
            } catch (error) {
                console.log("")
