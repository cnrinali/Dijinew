...
<input name="kart_id" type="hidden" value="<?php echo"$kart_id";?>">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-dark">Yükle</button>
	                   	...
	                   	<br>
				   <div class="text-center"><a href="sihirbaz-6"><button class="btn btn-ligh" style="border:1px solid #000;">Bu Adımı Atla</button></a></div>
<?PHP
}else{
...
<a href="sihirbaz-6"><button type="button" class="btn btn-dark">Sonraki Adım</button></a><br>
</div>
<?php
}else{
?>
