      ...
      <div class="row">
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
               <div class="card-body">
                  <h5 class="card-title">PASİF KARTVİZİT LİSTESİ | <a href="excel" alt="Excel Olarak İndir" title="Excel Olarak İndir"><button type="button" class="btn btn-dark"><i class="bi bi-folder"></i> Excel Olarak İndir</button></h5>
...
?>
					  ...
					  <?php if (isMobile()) { ?>
						...
						<img src="https://chart.googleapis.com/chart?cht=qr&chl=<?php echo"$domain";?>index?kart_id=<?php echo"$kart_id"?>&chs=160x160&chld=L|0" style="max-height:30px;" class="qr-code img-thumbnail img-responsive" />
						<h1></td>
						<?php }else{?>
						<td><?php echo"$isim $soyisim";?></td>
						...
						<a href="sil?id=<?php echo"$id";?>" alt="Sil" title="Sil"><i class="bx bx-trash"></i></a>
						<a href="duzenle?id=<?php echo"$id";?>" alt="Güncelle" title="Güncelle"><i class="bx bx-edit-alt"></i></a>
						<img src="https://chart.googleapis.com/chart?cht=qr&chl=<?php echo"$domain";?>index?kart_id=<?php echo"$kart_id"?>&chs=160x160&chld=L|0" style="max-height:40px;" class="qr-code img-thumbnail img-responsive" />
						</h1></td>
						<?php }?>
					  </tr>
<?php }?>
