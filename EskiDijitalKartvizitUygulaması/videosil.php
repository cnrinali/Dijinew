...
$delete		= $baglan->prepare("DELETE FROM `video` WHERE `id` =?");
$delete ->execute(array($id));
if (isset ($delete)){
/* LOG */
$tarih 		=date('d.m.Y',time());
$islem ="$id Numaralı Video Silindi";
...
?>
<div align="center"><h3>Silme İşlemi Başarısız</h3> <img src="assets/img/error.gif?v=0.1" border="0" height="64px"></div>
<?php	
}
}
 ?>
