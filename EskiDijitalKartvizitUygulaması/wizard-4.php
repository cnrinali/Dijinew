...
<input name="sosyal[]" type="hidden" value="link">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-dark">Ekle</button>
		                   	...
		                   	<br>
				   <div class="text-center"><a href="wizard-5?kart_id=<?php echo"$kart_id";?>"><button class="btn btn-ligh" style="border:1px solid #000;">Bu Adımı Atla</button></a></div>
<?php }else{
...
<a href="wizard-5?kart_id=<?php echo"$kart_id";?>"><button type="button" class="btn btn-dark">Sonraki Adım</button></a><br>
</div>
<?php
}else{
?>
