    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
				<h5 class="card-title">KİŞİSEL BİLGİLERİM</h5>	
<?php 
if(empty($_POST)){
$id		=$_GET["id"];
...
$guncelle ->execute(array($isim,$soyisim,$unvan,$telefon,$gsm,$email,$adres,$profilresim,$web,$hakkimda,$tema,$arkaresmim,$id));
if (isset ($guncelle)){
...
?>
<div align="center"><h3>Kartvizit Güncelleme Başarısız</h3><br><br> <a href="yonetim"><button type="button" class="btn btn-dark">Geri Dön</button></a></div>
<?php	
}
}
}
