...
<input name="kart_id" type="hidden" value="<?php echo"$kart_id";?>">
                    ...
                    <div class="text-center"><input type="hidden" name="action" value="image" />
                      <button type="submit" class="btn btn-dark">Yükle</button>
		                   	...
		                   	<br>
				   <div class="text-center"><a href="wizard-4?kart_id=<?php echo"$kart_id";?>"><button class="btn btn-light" style="border:1px solid #000;">Bu Adımı Atla</button></a></div>
<?php 
}else{
/* Resim Yükleme */
...
<a href="wizard-4?kart_id=<?php echo"$kart_id";?>"><button type="button" class="btn btn-dark">Sonraki Adım</button></a><br>
</div>
<?php
}else{
?>
