...
if($id =="1"){
echo'
<div align="center"><h3>Rezerve Bayi Silinemez</h3> <br><br><a href="yonetim"><button type="button" class="btn btn-dark">Panele Dön</button></a></div>
';	
}else{
$delete		= $baglan->prepare("DELETE FROM `bayi` WHERE `id` =?");
$delete ->execute(array($id));
if (isset ($delete)){
/* LOG */
$tarih 		=date('d.m.Y',time());
$islem ="$id Bayi Kullanıcı Silindi";
...
$rec = mysqli_query($baglan, $logkayit);
/* LOG */
